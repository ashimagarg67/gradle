...
import org.gradle.api.problems.internal.DeprecationAdditionalDataSpec;
        ...
        Problem problem = reporter.create(new Action<InternalProblemSpec>() {
            ...
            public void execute(InternalProblemSpec builder) {
                InternalProblemSpec problemSpec = builder
                    ...
                    .additionalData(DeprecationData.class, new Action<DeprecationAdditionalDataSpec>() {
                        @Override
                        public void execute(DeprecationAdditionalDataSpec spec) {
